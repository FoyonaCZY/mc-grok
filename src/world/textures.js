...
function createItemIcons(rng) {
  ...
  icons.shield = iconArt([
    ...
    ".....w==w......",
    "......ww.......",
  ], { w: [176, 122, 62], "=": [148, 148, 158], i: [70, 90, 170], I: [210, 40, 40] });

  icons.totem_of_undying = iconArt([
    "......gggg......",
    ".....gGGGg......",
    "....gGyeeGg.....",
    "....gGeeeeG.....",
    ...
    "......gGGg......",
    "......g..g......",
  ], { g: [40, 170, 70], G: [80, 220, 90], y: [250, 220, 40], e: [255, 210, 140], w: [230, 190, 50] });
